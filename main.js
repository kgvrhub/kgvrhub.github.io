(function () {
  ...
  const CATEGORIES = {
    branding: {
      label: 'Branding',
      items: [
        { src: 'assets/blank.png', alt: 'Blank — brand manifesto poster, "Every designer starts here," KGVR Media', client: 'Blank', concept: 'Brand Manifesto Poster', w: 1080, h: 1920 },
        { src: 'assets/obsidian-studio.png', alt: 'Obsidian Studio — logo and identity design for a luxury architecture practice', client: 'Obsidian Studio', concept: 'Logo & Identity System', w: 2000, h: 2000 }
      ]
    },
    automotive: {
      label: 'Automotive',
      items: [
        { src: 'assets/timeless.jpg', alt: 'Porsche 911 — Timeless campaign visual, rear three-quarter view', client: 'Porsche', concept: 'Timeless — 911 Campaign', w: 1920, h: 1080 }
      ]
    },
    beauty: {
      label: 'Beauty',
      items: [
        { src: 'assets/maes-beauty.png', alt: "Mae's Beauty Collections — logo and brand identity design", client: "Mae's Beauty Collections", concept: 'Logo & Brand Identity', w: 2000, h: 2000 }
      ]
    }
  };
  ...
  function buildOverlayItem(item) {
  ...
  function openCategory(key, triggerEl) {
    ...
    data.items.forEach(item => overlayGrid.appendChild(buildOverlayItem(item)));
